...
public class GefangenenDilemma {
	...
	// methods
	/**
	 * Startet ein Spiel mit den Strategien der Spieler und dem angegebenen
	 * Parameter als Spieldauer
	 * 
	 * @param length > int
	 */
	public void spiele(int length) {
		for (int i = 0; i < length; i++) {
			...
			setPunkte(decisionOne, decisionTwo);
		...
		System.out.println(strg1 + System.lineSeparator() + strg2 + System.lineSeparator() + "-".repeat(50)
				+ System.lineSeparator() + winner);
	 ...
	 * 
	 * @param decisionOne
	 * @param decisionTwo die Punkte die Spieler 1 und Spieler 2 bekommen. Beide
	 *                    Spieler Kooperieren --> beide bekommen 2 Punkte Beide
	 *                    Spieler Betruegen --> beide Spieler bekommen 4 Punkte Ein
	 *                    Spieler Betruegt und ein Spieler Kooperiert --> betrueger
	 *                    bekommt 1 Punkt, kooperierer bekommt 6 Punkt
	 */
	private void setPunkte(boolean decisionOne, boolean decisionTwo) {
